...
I would use the formula in the variable `compute.altbinom` to get the population moments then set them equal to their corresponding sample moments. I would then use that to find the Method of Moments for params `p` and `theta`
